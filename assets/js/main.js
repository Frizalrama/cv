...
(function () {
  ...
  var EN = {
    ...
    p3title: "Fiduciary Filing Automation",
    p3desc: "A bot that reads data from Excel, logs in automatically, bulk-downloads debtor documents, then fills the online registration form — including cascading address dropdowns — with zero manual input.",
    p3c1: "files / month", p3c2: "faster",
